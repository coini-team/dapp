...
export class fixUnfixableMigrations1706189309418 implements MigrationInterface {
  name = 'fixUnfixableMigrations1706189309418';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP INDEX \`FK_2d29a8162ec942b00d044d8e170\` ON \`access\``,
    );
    await queryRunner.query(
      `DROP INDEX \`FK_758d07e24268bb68acfc2ba8d33\` ON \`access\``,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX \`FK_758d07e24268bb68acfc2ba8d33\` ON \`access\` (\`project_id\`)`,
    );
    await queryRunner.query(
      `CREATE INDEX \`FK_2d29a8162ec942b00d044d8e170\` ON \`access\` (\`user_id\`)`,
    );
  }
}
